const translations = {
  zh: {
    ...
    smallBull: "小牛年",
    monthChangeLabel: "本月",
    dataConnecting: "正在连接 Binance 行情…",
    dataLive: "实时 · Binance",
    dataSnapshot: "快照",
    dataOffline: "行情中断",
    dataUnavailable: "实时行情不可用",
    dataAsOf: "截至",
    tooltipOpen: "开盘价",
    tooltipClose: "收盘价",
    tooltipChange: "涨跌幅",
  ...
  en: {
    ...
    dataConnecting: "Connecting to Binance…",
    dataLive: "Live · Binance",
    dataSnapshot: "Snapshot",
    dataOffline: "Feed interrupted",
    dataUnavailable: "Live market data unavailable",
    dataAsOf: "as of",
    tooltipOpen: "Open",
    tooltipClose: "Close",
